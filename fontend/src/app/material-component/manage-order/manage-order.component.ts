...
export class ManageOrderComponent implements OnInit {
  ...
  setQuantity(value: any) {
    ...
    if (/^\d+$/.test(temp) && temp !== '0') {
      this.manageOrderForm.controls['total'].setValue(GlobalConstants.round(this.manageOrderForm.controls['quantity'].value * this.manageOrderForm.controls['price'].value));
    } else if (temp != '') {
      this.manageOrderForm.controls['quantity'].setValue('1');
      this.manageOrderForm.controls['total'].setValue(GlobalConstants.round(this.manageOrderForm.controls['quantity'].value * this.manageOrderForm.controls['price'].value));
    }
  ...
  add() {
    ...
    if (productName === undefined) {
      this.totalAmount = GlobalConstants.round(this.totalAmount + formData.total);
  ...
  handleDeleteAction(value: any, element: any) {
    this.totalAmount = GlobalConstants.round(this.totalAmount - element.total);
